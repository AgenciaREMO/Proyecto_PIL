...
<body >
	...
	<div class="bg-content">
		<section class="content" style="position:relative">
			<img src="rec/img/banners_jpg/recetas_alitasadobadas.jpg" alt="" class="img-responsive">
			...
			<div class="cont-recetas">
				<div class="row">
					<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
						<p class="title-receta">Alitas de pollo adobadas, rebozadas </p>
						<p class="com-receta">en cóctel de frutas mixtas</p>
				...
				<div class="row">
					<div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 " >
						...
						<div class="ing">
							<p>1 Paquete de <a href="alas_adobadas.php" data-toggle="tooltip" data-placement="top" title="Ver producto"><b><i>Alitas adobadas Pilgrim’s.</i></b></a></p>
							<p>1/2 Taza de salsa de tomate.</p>
							<p>1 Lata mediana de cóctel de frutas.</p>
							<p>1 Cucharada de jengibre rallado.</p>
						...
						<table width="97%">
							<tr>
								...
								<td style="padding: 2%; font-style: normal; color: #6e6e6d; font-size: 1.2em">
									Cubre las <a href="alas_adobadas.php" data-toggle="tooltip" data-placement="top" title="Ver producto"><b><i>alitas</i></b></a> con el jengibre rallado y fríelas perfectamente.
								</td>
							</tr>
							<tr>
								<td width="13%;" >
