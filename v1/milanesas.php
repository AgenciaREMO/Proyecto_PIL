		...
		<section class="content nuestras-marcas" data-speed="2" data-type="background">
			<div class="container">
				...
				<div class="row productos bg-productos" style="margin-bottom:5%;">
					<div class="col-lg-12 col-md-12 col-sm-12">
						<img src="rec/img/pleca_milanesas.png" alt="Cinta milanesas" class="img-responsive animated fadeInDown" style="margin: 5% auto;">
					</div>
					<div class="col-lg-6 col-md-6 col-sm-12" >
						...
						<p class="animated fadeInDown" style="font-size:1.3em;">Filete de pechuga en diversas porciones por empaque para el número de comensales que necesites.</p>
						<br>
						<hr class="hr-productos">
						<div class="col-lg-12 col-md-12 col-sm-12 producto movil-historia">
							<div style="background:url('rec/img/nuestras_marcas/charola_milanesa_aplanada_back.jpg') no-repeat center;" class=" animated zoomIn">
								<img src="rec/img/nuestras_marcas/charola_milanesa_aplanada.png" alt="Milanesas" class="img-responsive img-thumbnail thumbnail-producto" style="max-width:100%">
							</div>
						</div>
							...
							<a href="r1-pollo-en-tomate.php" >
								...
								<div class="col-lg-7 col-md-7 col-sm-8 col-xs-9  text-right" style="margin-left:0px; float: none;display: table-cell; vertical-align: middle;">
									<h3 style="color:#071689; text-align:right;">
										Pierna y muslo corte americano con rajas y champiñones
									</h3>
									Ver receta
								</div>
								<div class="col-lg-3 col-md-3 col-sm-2 col-xs-2" style="padding:0px; float: none;display: table-cell; vertical-align: middle;">
									<img src="rec/img/recetas/espagueti_de_pollo_en_salsa_de_tomate.jpg" alt="Espagueti con pollo en salsa de tomate" style="width:100%;" class="miniatura-receta">
								</div>
							</a>
						</div>
					</div>
