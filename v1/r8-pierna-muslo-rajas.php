...
<body >
	...
	<div class="bg-content">
		<section class="content" style="position:relative">
			<img src="rec/img/banners_jpg/recetas_piernamuslorajas.jpg" alt="" class="img-responsive">
				...
				<div class="row">
					<div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 " >
						...
						<div class="ing">
							...
							<p>4 Tazas de champiñones crudos, limpios y rebanados.</p> 
							<p>3 Chiles poblanos asados, limpios y cortados en tiras.</p>
							<p>1 Taza de cebolla cruda rebanada en rodajas.</p>
							<p>Aceite en aerosol (5 disparos).</p>
							<p>Sal y epazote al gusto.</p>
						</div>
					</div>
