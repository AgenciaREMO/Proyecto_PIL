...
<html lang="es">
	<head>
	  	...
	  	<?php meta(); ?>
	  	<title>Muslos de pollo Pilgrim’s al tamarindo - PILGRIM'S</title>
	...
	<div>
		<section class="container ">
			...
			<ol class="breadcrumb" style="background: rgba(255,255,255, 0.7)">
			  ...
			  <li class="active">Muslos de pollo Pilgrim’s al tamarindo</li>
			</ol>
	</div>
	<div class=" bg-r">
		<section class="container ">
			<div class="esc-header-recetas">
				<div class="row">
					<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 text-center">
						<i class="fa fa-clock-o fa-2x" aria-hidden="true"></i><span class="ico-cook"> 40 min. de preparación</span>
					</div>
					<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 text-center">
						<i class="fa fa-cutlery fa-2x" aria-hidden="true"></i> <span class="ico-cook"> 4 Porciones</span>
					</div>
					<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 text-center">
						<i class="fa fa-download fa-2x" aria-hidden="true"></i> <span class="ico-cook"> Descargar</span>
					</div>
				</div>
			</div>
			<div class="esc-receta">
				<div class="row">
					<div class="col-lg-6 col-md-6 col-sm-12">
						...
						<br>
						<li>6 muslos de pollo Pilgrim’s</li>
						<li>2 tazas de pulpa de tamarindo</li>
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 text-justify">
						...
						<br>
						En una sartén agrega la mantequilla y fríe los muslos Pilgrim’s Premium. En la misma sartén incorpora los ingredientes restantes y déjalos hervir hasta que la salsa tenga una consistencia espesa. Baña con esta salsa los muslos de pollo Pilgrim’s Premium y acompaña con arroz salvaje y brócoli.<br>
						<b>TIP : </b>
						Si deseas que la salsa tenga una consistencia líquida, añade 1/2 taza de refresco de cola para la cocción.
					</div>
				</div>
			</div>
			...
			<div class="mob-receta">
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12">
						...
						<hr style="width:75%; background:#25346d; text-aling-center; margin:0px; height:1px;">
						<br>
						<li>4 mitades de pechuga de pollo Pilgrim’s, sin hueso.</li>
