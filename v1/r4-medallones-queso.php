...
<html lang="es">
	<head>
	  	...
	  	<?php meta(); ?>
	  	<title>Medallones de pollo Pilgrim’s con brócoli en salsa de queso - PILGRIM'S</title>
		<meta name="description" content="Pilgrim’s Receta de Medallones de pollo Pilgrim’s con brócoli en salsa de queso.">
	...
	<div class="bg-content">
		...
		<section class="container">
			<ol class="breadcrumb">
			  ...
			  <li class="active">Medallones de pollo Pilgrim’s con brócoli en salsa de queso.</li>
			</ol>
			<div class="cont-recetas">
				<div class="row">
					<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
						<p class="title-receta">Medallones de pollo Pilgrim’s</p>
						<p class="com-receta">con brócoli en salsa de queso</p>
				...
				<div class="row">
					<div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 " >
						...
						<div class="ing">
							<p>1 Lata de 420 gramos de queso crema.</p>
							<p>1 Taza de leche.</p>
							<p>6 <a href="medallones.php" data-toggle="tooltip" data-placement="top" title="Ver producto"><b><i>Medallones de muslo Pilgrim's.</i></b></a></p>
							<p>90 Gramos de mantequilla o margarina.</p>
							<p>2 Tazas de trozos de brócol cocido(fresco o congelado).</p>
						</div>
					</div>
					<div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 " >
						...
						<table width="97%">
							...
							<tr>
								...
								<td style="padding: 2%; font-style: normal; color: #6e6e6d; font-size: 1.2em">
									Apártalos. En la misma olla, agrega y mezcla la crema de queso y la leche. 
								</td>
							</tr>
							<tr>
								<td width="13%;" >
								...
								<td style="padding: 2%; font-style: normal; color: #6e6e6d; font-size: 1.2em">
									Después agrega el brócoli y los medallones, cocínalos por 5 minutos o hasta que los medallones estén bien cocidos.
								</td>
							</tr>
							<tr>
								<td width="13%;" >
								...
								<td style="padding: 2%; font-style: normal; color: #6e6e6d; font-size: 1.2em">
									<b>Sugerencia:</b> Acompáñalos con una pasta bañada con salsa Molto Bene.
								</td>
							</tr>
						</table>
					</div>
