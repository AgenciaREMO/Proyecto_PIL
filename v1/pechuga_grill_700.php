				...
				<div class="row productos bg-productos">
					<div class="col-lg-12 col-md-12 col-sm-12 producto">
						<h2 class="h2-producto">
							Pechuga grill 700 gr
							<hr class="hr-rojo">
						</h2>
					</div>
					<div class="col-lg-6 col-md-6 col-sm-12 producto" >
						<img src="rec/img/nuestras_marcas/pechuga_grill_700.png" alt="Pechuga grill 700 gr" class="img-responsive img-thumbnail thumbnail-producto animated zoomIn">
					</div>
