...
<body >
	...
	<div class="bg-content">
		<section class="content" style="position:relative">
			<img src="rec/img/banners_jpg/recetas_pechugasrellenasespinacas.jpg" alt="" class="img-responsive">
			...
			<div class="cont-recetas">
				<div class="row">
					<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
						<p class="title-receta">Pechuga rellenas </p>
						<p class="com-receta">de espinacas</p>
				...
				<div class="row">
					<div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 " >
						...
						<div class="ing">
							...
							<p>8 hojas de espinaca lavadas y desinfectadas.</p>
							<p>1/2 metro de egapack (plastico tipo bolsa).</p>
							<p>Sal pimienta.</p>
							<p>Mantequilla.</p>
							<p>¼ de taza de crema.</p>
							<p>¼ de taza de leche.</p>
						</div>
					</div>
