		...
		<section class="content nuestras-marcas" data-speed="2" data-type="background">
			<div class="container">
				<ol class="breadcrumb">
					...
					<li class="active">Boneless original hot</li>
				</ol>
				...
				<div class="row productos bg-productos" style="padding-top:3%; padding-bottom:3%;">
					...
					<div class="col-lg-6 col-md-6 col-sm-12 producto desktop-historia" >
						<div class=" animated zoomIn">
							<img src="rec/img/nuestras_marcas/boneless_original_hot.png" alt="Boneless original hot" class="img-responsive thumbnail-producto">
						</div>
					</div>
				</div>
			</div>
