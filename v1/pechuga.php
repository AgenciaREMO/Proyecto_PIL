			...
			<div class="container">
				...
				<div class="row productos bg-productos">
					...
					<div class="col-lg-6 col-md-6 col-sm-12 producto" >
						<div style="background:url('rec/img/nuestras_marcas/charola_pechuga_entera_back.jpg');background-size: cover;">
							<img src="rec/img/nuestras_marcas/charola_pechuga_entera.jpg" alt="Pollo entero" class="img-responsive img-thumbnail thumbnail-producto">
						</div>
					</div>
					<div class="col-lg-6 col-md-6 col-sm-12" >
						<table style="border:none;">
							<tr>
								<td>
									<p style="margin-top:0px;">Pechuga entera, deshuesada, con hueso, con piel, sin piel y aplanada lista para asar.</p>
									<p style="margin:5px;">Vistas:</p>
									<img src="rec/img/nuestras_marcas/charola_pechuga_entera.jpg" alt="Pollo entero" class="miniatura-vista" id="frente">
									<img src="rec/img/nuestras_marcas/charola_pechuga_entera_back.jpg" alt="Pollo entero back" class="miniatura-vista" id="back">
								</td>
							</tr>
							<tr>
								<td class="a-receta">
