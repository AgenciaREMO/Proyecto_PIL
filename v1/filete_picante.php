				...
				<div class="row productos bg-productos" style="padding-top:3%; padding-bottom:3%;">
					...
					<div class="col-lg-6 col-md-6 col-sm-12" >
						...
						<div class="col-lg-12 col-md-12 col-sm-12 producto movil-historia">
							<div style="background:url('rec/img/nuestras_marcas/filete_picante_back.png') no-repeat center; background-size:auto 363px;" class=" animated zoomIn">
						...
						<div class="vista animated fadeInUp">
							...
							<div class="col-lg-9">
								<img src="rec/img/nuestras_marcas/filete_picante.png" alt="Filete empanizado picante" class="miniatura-vista" id="frente">
								<img src="rec/img/nuestras_marcas/filete_picante_back.png" alt="Filete empanizado picante back" class="miniatura-vista" id="back">
							</div>
						</div>
					</div>
