		...
		<section class="content nuestras-marcas" data-speed="2" data-type="background">
			<div class="container">
				<ol class="breadcrumb">
					...
					<li class="active">Arrachera adobada 1.2 kg</li>
				</ol>
				...
				<div class="row productos bg-productos" style="padding-top:3%; padding-bottom:3%;">
					<div class="col-lg-12 col-md-12 col-sm-12">
						<img src="rec/img/pleca_arrachera_adobada.png" alt="Cinta arrachera adobada" class="img-responsive animated fadeInDown" style="margin: 10px auto;">
					</div>
					<div class="col-lg-6 col-md-6 col-sm-12" >
						...
						<p class="animated fadeInDown" style="font-size:1.3em;">Arracheras de muslo de pollo marinadas con sabor adobo, totalmente cocinadas.</p>
						...
						<div class="col-lg-12 col-md-12 col-sm-12 producto movil-historia">
							<div style="background:url('rec/img/nuestras_marcas/arrachera_adobada_back.png') no-repeat center; background-size:auto 363px;" class=" animated zoomIn">
								<img src="rec/img/nuestras_marcas/arrachera_adobada_1-2k.png" alt="Arrachera adobada 1.2 kg" class="img-responsive img-thumbnail thumbnail-producto" style="max-width:100%">
							</div>
						</div>
						<div class="vista animated fadeInUp">
							...
							<div class="col-lg-9">
								<img src="rec/img/nuestras_marcas/arrachera_adobada_1-2k.png" alt="Arrachera adobada 1.2 kg" class="miniatura-vista" id="frente">
								<img src="rec/img/nuestras_marcas/arrachera_adobada_back.png" alt="Arrachera adobada 1.2 kg back" class="miniatura-vista" id="back">
							</div>
						</div>
					</div>
					<div class="col-lg-6 col-md-6 col-sm-12 producto desktop-historia" >
						<div style="background:url('rec/img/nuestras_marcas/arrachera_adobada_back.png') no-repeat center; background-size:auto 363px;" class=" animated zoomIn">
							<img src="rec/img/nuestras_marcas/arrachera_adobada_1-2k.png" alt="Arrachera adobada 1.2 kg" class="img-responsive img-thumbnail thumbnail-producto">
						</div>
					</div>
				</div>
			</div>
