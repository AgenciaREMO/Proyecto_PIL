			...
			<div class="container">
				...
				<div class="row productos bg-productos">
					...
					<div class="col-lg-6 col-md-6 col-sm-12 producto" >
						<img src="rec/img/nuestras_marcas/pechuga_navidenia.png" alt="Pechuga navideña" class="img-responsive img-thumbnail thumbnail-producto animated zoomIn">
					</div>
					<div class="col-lg-6 col-md-6 col-sm-12" >
						<h3 class="animated fadeInDown">Pechugas de pollo rellenas de queso crema, manzana, uvas pasas y mermelada de fresa.</h3>
						<br>
