		...
		<section class="content nuestras-marcas" data-speed="2" data-type="background">
			<div class="container">
				...
				<div class="row productos bg-productos" style="margin-bottom:5%;">
					<div class="col-lg-12 col-md-12 col-sm-12">
						<img src="rec/img/pleca_alas_naturales.png" alt="Cinta alas naturales" class="img-responsive animated fadeInDown" style="margin: 5% auto;">
					</div>
					<div class="col-lg-6 col-md-6 col-sm-12" >
						...
						<p class="animated fadeInDown" style="font-size:1.3em;">Alitas naturales en diversas presentaciones para un antojo en casa o para deleitar a tantos invitados como quieras.</p>
						<br>
						<hr class="hr-productos">
						<div class="col-lg-12 col-md-12 col-sm-12 producto movil-historia">
							<div style="background:url('rec/img/nuestras_marcas/alas_naturales_temporal_back.jpg') no-repeat center;" class=" animated zoomIn">
							...
							<a href="r5-alitas-tamarindo.php" >
								...
								<div class="col-lg-7 col-md-7 col-sm-8 col-xs-9  text-right" style="margin-left:0px; float: none;display: table-cell; vertical-align: middle;">
									<h3 style="color:#071689; text-align:right;">
										Alitas de pollo en salsa de tamarindo picante
									</h3>
									Ver receta
								</div>
