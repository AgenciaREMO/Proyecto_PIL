			...
			<div class="container">
				...
				<div class="row productos bg-productos">
					...
					<div class="col-lg-6 col-md-6 col-sm-12 producto" >
						<img src="rec/img/nuestras_marcas/filete_empanizado.png" alt="Filete empanizado" class="img-responsive img-thumbnail thumbnail-producto animated zoomIn">
					</div>
					<div class="col-lg-6 col-md-6 col-sm-12" >
						<h3 class="animated fadeInDown">Filetes de pollo empanizados,<br>parcialmente cocinados.</h3>
						<br>
