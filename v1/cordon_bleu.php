				...
				<div class="row productos bg-productos">
					<div class="col-lg-12 col-md-12 col-sm-12 producto">
						<h2 class="h2-producto">
							Pechuga rellena cordon bleu
							<hr class="hr-rojo">
						</h2>
					</div>
					<div class="col-lg-6 col-md-6 col-sm-12 producto" >
						<img src="rec/img/nuestras_marcas/cordon_bleu.png" alt="Pechuga rellena cordon bleu" class="img-responsive img-thumbnail thumbnail-producto animated zoomIn">
					</div>
					<div class="col-lg-6 col-md-6 col-sm-12" >
						<h3 class="animated fadeInDown">Pechugas de pollo rellenas de jamón y queso, formadas, empanizadas y parcialmente cocinadas.</h3>
						<br>
						<h3 class="animated fadeInDown">Contenido neto 720gr.</h3>
					</div>
				</div>
			</div>
		</section>
