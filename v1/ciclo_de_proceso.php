...
<html lang="es">
	<head>
		...
		<meta name="description" content="Ciclo de proceso en Pilgrim’s productora de pollo en México">
		<meta name="keywords" content="Pilgrim's, ciclo, proceso, producción">
		...
		<section class="contenido-ciclo">
			<div class="ciclo-escritorio">
				<div class="row ani-img">
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 t">
						<b>Nuestro pollo posee una calidad incomparable, gracias al esfuerzo de cientos de mexicanos, que hacen esto realidad</b>
					</div>
				</div>
				...
				<!-- DOS-->
					<div class="text-ciclo filtro">
						...
						<div class="col-lg-6 col-md-6 text-hover-2 text-left seis">
							<span class="titulos-ciclo"><b>PROGENITORAS:</b></span>
							<p>Para tener el mejor pollo, se necesita la mejor genética.  El primer eslabón en la cadena de vida de cada uno de nuestros pollitos, comienza con la llegada de las aves progenitoras de Estados Unidos.  Estas aves cuentan con tan solo un día de nacidos y bajo estrictas medidas de bioseguridad, producen los huevos que 21 días después se convertirán en nuestras aves reproductoras, es decir, en “las mamás de los pollitos”</p>
						</div><br>
					</div>
				<!-- FIN DOS-->
				</div>
				...
				<!-- CUATRO-->
					<div class="text-ciclo filtro">
						...
						<div class="col-lg-6 col-md-6 text-hover-4 text-left cuatro">
							<span class="titulos-ciclo"><b>INCUBADORAS:</b></span>
							<p>Cuidar un huevo para que se vuelva un pollito, pareciera fácil pero hay que cuidar temperatura, humedad y manejo del mismo, de lo contrario no se lograría el nacimiento del pollito.</p>
						</div><br/>
					</div>
				<!-- FIN CUATRO-->
				</div>
				...
				<!-- SEIS-->
					<div class="text-ciclo filtro">
						...
						<div class="col-lg-6 col-md-6 text-hover-6 text-left cuatro">
							<span class="titulos-ciclo"><b>PLANTA PROCESADORA:</b></span>
	 						<p>Al recibir los pollos se insensibilizan para proceder a un sacrificio sin dolor. Enseguida se realiza un proceso de lavado, desplume, eviscerado para garantizar que la carne del pollo esté limpia.</p>
						</div>
					</div>
				<!-- FIN SEIS-->
				</div>
			...
			<div class="ciclo-mobil" >
				...
				<!-- UNO-->
					<div class="text-ciclo">
						<div class="col-lg-6 col-md-6 col-sm-6  col-sm- 12 text-hover-1-mob text-right cuatro">
							<span class="titulos-ciclo"><b>PLANTA DE ALIMENTOS:</b></span>
	 						<p>Nos aseguramos que nuestros pollos tengan la mejor alimentación, por eso nosotros mismos producimos su alimento con el balance de nutrientes que necesitan en cada etapa de crecimiento.</p>
	 					</div>
						<div class="col-lg-6 col-md-6 col-sm-6  col-sm- 12 img-hover-1-mob filtro" style="padding-left: 0px !important; padding-right: 0px !important;">
							<img style="margin: auto; width: 100%; padding-left: 0px !important; padding-right: 0px !important;" class="img-responsive" src="rec/img/proceso/alimentos.jpg">
						</div>
					</div>
				<!-- FIN UNO-->
				<!-- DOS-->
					<div class="text-ciclo">
						<div class="col-lg-6 col-md-6 col-sm-6  col-sm- 12 img-hover-2-mob filtro" style="padding-left: 0px !important; padding-right: 0px !important;">
							<img style="margin: auto; width: 100%; padding-left: 0px !important; padding-right: 0px !important;" class="img-responsive" src="rec/img/proceso/progenitoras.jpg">
						</div>
						<div class="col-lg-6 col-md-6 col-sm-6  col-sm- 12 text-hover-2-mob text-left seis">
							<span class="titulos-ciclo"><b>PROGENITORAS:</b></span>
							<p>Para tener el mejor pollo, se necesita la mejor genética.  El primer eslabón en la cadena de vida de cada uno de nuestros pollitos, comienza con la llegada de las aves progenitoras de Estados Unidos.  Estas aves cuentan con tan solo un día de nacidos y bajo estrictas medidas de bioseguridad, producen los huevos que 21 días después se convertirán en nuestras aves reproductoras, es decir, en “las mamás de los pollitos”</p>
						</div>
						<br>
				...
				<!-- TRES-->
					<div class="text-ciclo">
						<div class="col-lg-6 col-md-6 col-sm-6  col-sm- 12 text-hover-3-mob text-right seis">
							<span class="titulos-ciclo"><b>REPRODUCTORAS: </b></span>
	 						<p>El manejo de las reproductoras se vuelve más especializado. Los huevos que produzcan serán enviados a las incubadoras para después ser criados y posteriormente enviados a las plantas de proceso. <br/>Cada una de las aves progenitoras produce durante su vida útil alrededor de 150 huevos. La vida útil de una reproductora es entre los 140 y 448 días.</p>
	 					</div>
						<div class="col-lg-6 col-md-6 col-sm-6  col-sm- 12 img-hover-3-mob filtro" style="padding-left: 0px !important; padding-right: 0px !important;">
							<img style="margin: auto; width: 100%; padding-left: 0px !important; padding-right: 0px !important;" class="img-responsive" src="rec/img/proceso/reproductoras.jpg">
						</div><br/>
					</div>
				<!-- FIN TRES-->
				<!-- CUATRO-->
					<div class="text-ciclo">
						<div class="col-lg-6 col-md-6 col-sm-6  col-sm- 12 img-hover-4-mob filtro" style="padding-left: 0px !important; padding-right: 0px !important;">
							<img style="margin: auto; width: 100%; padding-left: 0px !important; padding-right: 0px !important;" class="img-responsive" src="rec/img/proceso/incubadoras.jpg">
						</div>
						<div class="col-lg-6 col-md-6 col-sm-6  col-sm- 12 text-hover-4-mob text-left cuatro">
							<span class="titulos-ciclo"><b>INCUBADORAS:</b></span>
							<p>Cuidar un huevo para que se vuelva un pollito, pareciera fácil pero hay que cuidar temperatura, humedad y manejo del mismo, de lo contrario no se lograría el nacimiento del pollito.</p>
						</div><br/>
					</div>
				...
				<!-- CINCO-->
					<div class="text-ciclo">
						<div class="col-lg-6 col-md-6 col-sm-6  col-sm- 12 text-hover-5-mob text-right seis">
							<span class="titulos-ciclo"><b>POLLO DE ENGORDA:</b></span>
	 						<p>La crianza inicia con la recepción de parvadas de pollito de 1 día de edad, cuando llega a la granja, diversos factores que determinan su crecimiento. <br/>En esta etapa no sólo se cuida la biodiversidad, sino también el bienestar de los pollos, es decir, que estén libres de: hambre, sed, incomodidad, dolor, lesiones, enfermedad, miedo y angustia.</p>
	 					</div>
						<div class="col-lg-6 col-md-6 col-sm-6  col-sm- 12 img-hover-5-mob filtro" style="padding-left: 0px !important; padding-right: 0px !important;">
							<img style="margin: auto; width: 100%; padding-left: 0px !important; padding-right: 0px !important;" class="img-responsive" src="rec/img/proceso/pollo_en_engorda.jpg">
						</div><br/>
					</div>
				<!-- FIN CINCO-->
				<!-- SEIS-->
					<div class="text-ciclo">
						<div class="col-lg-6 col-md-6 col-sm-6  col-sm- 12 img-hover-6-mob filtro" style="padding-left: 0px !important; padding-right: 0px !important;">
							<img style="margin: auto; width: 100%; padding-left: 0px !important; padding-right: 0px !important;" class="img-responsive" src="rec/img/proceso/procesadora.jpg">
						</div>
						<div class="col-lg-6 col-md-6 col-sm-6  col-sm- 12 text-hover-6-mob text-left cuatro">
							<span class="titulos-ciclo"><b>PLANTA PROCESADORA:</b></span>
	 						<p>Al recibir los pollos se insensibilizan para proceder a un sacrificio sin dolor. Enseguida se realiza un proceso de lavado, desplume, eviscerado para garantizar que la carne del pollo esté limpia.</p>
						</div>
					</div>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('.text-hover-1-mob').css('opacity', '0');
		$('.img-hover-2-mob').css('opacity', '0');
		$('.text-hover-2-mob').css('opacity', '0');
		$('.img-hover-3-mob').css('opacity', '0');
		$('.text-hover-3-mob').css('opacity', '0');
		$('.img-hover-4-mob').css('opacity', '0');
		$('.text-hover-4-mob').css('opacity', '0');
		$('.img-hover-5-mob').css('opacity', '0');
		$('.text-hover-5-mob').css('opacity', '0');
		$('.img-hover-6-mob').css('opacity', '0');
		$('.text-hover-6-mob').css('opacity', '0');
		$('.img-hover-7-mob').css('opacity', '0');
		$('.text-hover-7-mob').css('opacity', '0');
		$('.img-hover-8-mob').css('opacity', '0');
		$('.text-hover-8-mob').css('opacity', '0');
		$('.img-hover-9-mob').css('opacity', '0');
		$('.text-hover-9-mob').css('opacity', '0');


		$('.ani-img').waypoint(function(direction) {
			$(this).css('opacity', '1');
			...
			$('.img-hover-1-mob').waypoint(function(direction) {
				$(this).css('opacity', '1');
				$(this).css('-webkit-transition', 'opacity .3s ease-in-out');
				$(this).addClass('animated slideInRight');	 
			}, { offset: '70%' });

			$('.text-hover-1-mob').waypoint(function(direction) {
				$(this).css('opacity', '1');
				$(this).css('-webkit-transition', 'opacity .3s ease-in-out');
				$(this).addClass('animated slideInLeft');	 
			}, { offset: '70%' });

			$('.img-hover-2-mob').waypoint(function(direction) {
				$(this).css('opacity', '1');
				$(this).css('-webkit-transition', 'opacity .3s ease-in-out');
				$(this).addClass('animated slideInRight');	 
			}, { offset: '70%' });

			$('.text-hover-2-mob').waypoint(function(direction) {
				$(this).css('opacity', '1');
				$(this).css('-webkit-transition', 'opacity .3s ease-in-out');
				$(this).addClass('animated slideInLeft');	 
			}, { offset: '70%' });

			$('.img-hover-3-mob').waypoint(function(direction) {
				$(this).css('opacity', '1');
				$(this).css('-webkit-transition', 'opacity .3s ease-in-out');
				$(this).addClass('animated slideInRight');	 
			}, { offset: '70%' });

			$('.text-hover-3-mob').waypoint(function(direction) {
				$(this).css('opacity', '1');
				$(this).css('-webkit-transition', 'opacity .3s ease-in-out');
				$(this).addClass('animated slideInLeft');	 
			}, { offset: '70%' });

			$('.img-hover-4-mob').waypoint(function(direction) {
				$(this).css('opacity', '1');
				$(this).css('-webkit-transition', 'opacity .3s ease-in-out');
				$(this).addClass('animated slideInRight');	 
			}, { offset: '70%' });

			$('.text-hover-4-mob').waypoint(function(direction) {
				$(this).css('opacity', '1');
				$(this).css('-webkit-transition', 'opacity .3s ease-in-out');
				$(this).addClass('animated slideInLeft');	 
			}, { offset: '70%' });
			$('.img-hover-5-mob').waypoint(function(direction) {
				$(this).css('opacity', '1');
				$(this).css('-webkit-transition', 'opacity .3s ease-in-out');
				$(this).addClass('animated slideInRight');	 
			}, { offset: '70%' });

			$('.text-hover-5-mob').waypoint(function(direction) {
				$(this).css('opacity', '1');
				$(this).css('-webkit-transition', 'opacity .3s ease-in-out');
				$(this).addClass('animated slideInLeft');	 
			}, { offset: '70%' });

			$('.img-hover-6-mob').waypoint(function(direction) {
				$(this).css('opacity', '1');
				$(this).css('-webkit-transition', 'opacity .3s ease-in-out');
				$(this).addClass('animated slideInRight');	 
			}, { offset: '70%' });

			$('.text-hover-6-mob').waypoint(function(direction) {
				$(this).css('opacity', '1');
				$(this).css('-webkit-transition', 'opacity .3s ease-in-out');
				$(this).addClass('animated slideInLeft');	 
			}, { offset: '70%' });
			$('.img-hover-7-mob').waypoint(function(direction) {
				$(this).css('opacity', '1');
				$(this).css('-webkit-transition', 'opacity .3s ease-in-out');
				$(this).addClass('animated slideInRight');	 
			}, { offset: '70%' });

			$('.text-hover-7-mob').waypoint(function(direction) {
				$(this).css('opacity', '1');
				$(this).css('-webkit-transition', 'opacity .3s ease-in-out');
				$(this).addClass('animated slideInLeft');	 
			}, { offset: '70%' });

			$('.img-hover-8-mob').waypoint(function(direction) {
				$(this).css('opacity', '1');
				$(this).css('-webkit-transition', 'opacity .3s ease-in-out');
				$(this).addClass('animated slideInRight');	 
			}, { offset: '70%' });

			$('.text-hover-8-mob').waypoint(function(direction) {
				$(this).css('opacity', '1');
				$(this).css('-webkit-transition', 'opacity .3s ease-in-out');
				$(this).addClass('animated slideInLeft');	 
			}, { offset: '70%' });

			$('.img-hover-9-mob').waypoint(function(direction) {
				$(this).css('opacity', '1');
				$(this).css('-webkit-transition', 'opacity .3s ease-in-out');
				$(this).addClass('animated slideInRight');	 
			}, { offset: '70%' });

			$('.text-hover-9-mob').waypoint(function(direction) {
				$(this).css('opacity', '1');
				$(this).css('-webkit-transition', 'opacity .3s ease-in-out');
				$(this).addClass('animated slideInLeft');	 
			}, { offset: '70%' });
