		...
		<section class="content nuestras-marcas" data-speed="2" data-type="background">
			<div class="container">
				...
				<div class="row productos bg-productos" style="margin-bottom:5%;">
					<div class="col-lg-12 col-md-12 col-sm-12">
						<img src="rec/img/pleca_pierna_muslo.png" alt="Cinta pierna muslo" class="img-responsive animated fadeInDown" style="margin: 5% auto;">
					</div>
					<div class="col-lg-6 col-md-6 col-sm-12" >
						...
						<p class="animated fadeInDown" style="font-size:1.3em;">Esta pieza completa la puedes encontrar en corte anatómico o corte americano.</p>
						<br>
						<hr class="hr-productos">
						<div class="col-lg-12 col-md-12 col-sm-12 producto movil-historia">
							<div style="background:url('rec/img/nuestras_marcas/charola_pierna_muslo_back.jpg') no-repeat center;" class=" animated zoomIn">
								<img src="rec/img/nuestras_marcas/charola_pierna_muslo.png" alt="Pierna y muslo" class="img-responsive img-thumbnail thumbnail-producto" style="max-width:100%">
							</div>
						</div>
						...
						<div class="row" style="background-color:#e7e7e7; color:#071689; padding:0px; width:100%; margin:2% 0px !important; display: table;">
							<a href="r8-pierna-muslo-rajas.php" >
								...
								<div class="col-lg-3 col-md-3 col-sm-2 col-xs-2" style="padding:0px; float: none;display: table-cell; vertical-align: middle;">
									<img src="rec/img/recetas/pierna_muslo_con_rajas_champinones.jpg" alt="Pierna y muslo corte americano con rajas y champiñones" style="width:100%;" class="miniatura-receta">
								</div>
							</a>
						</div>
					</div>
