			...
			<div class="container">
				...
				<div class="row productos bg-productos" style="margin-bottom:5%;">
					...
					<div class="col-lg-6 col-md-6 col-sm-12" >
						...
						<div class="col-lg-12 col-md-12 col-sm-12 producto movil-historia">
							<div class=" animated zoomIn">
								<img src="rec/img/nuestras_marcas/charola_pierna_muslo.png" alt="Pierna y muslo" class="img-responsive thumbnail-producto" style="max-width:100%">
							</div>
						</div>
					...
					<div class="col-lg-6 col-md-6 col-sm-12 producto desktop-historia" >
						<div class=" animated zoomIn">
							<img src="rec/img/nuestras_marcas/charola_pierna_muslo.png" alt="Pierna y muslo" class="img-responsive thumbnail-producto">
						</div>
					</div>
				</div>
			</div>
