				...
				<div class="row productos bg-productos" style="padding-top:3%; padding-bottom:3%;">
					...
					<div class="col-lg-6 col-md-6 col-sm-12" >
						...
						<div class="col-lg-12 col-md-12 col-sm-12 producto movil-historia">
							<div style="background:url('rec/img/nuestras_marcas/nuggets_back.png') no-repeat center; background-size:auto 363px;" class=" animated zoomIn">
								<img src="rec/img/nuestras_marcas/nuggets.png" alt="Nuggets empanizados" class="img-responsive img-thumbnail thumbnail-producto" style="max-width:100%">
							</div>
						</div>
						<div class="vista animated fadeInUp">
							...
							<div class="col-lg-9">
								<img src="rec/img/nuestras_marcas/nuggets.png" alt="Nuggets empanizados" class="miniatura-vista" id="frente">
								<img src="rec/img/nuestras_marcas/nuggets_back.png" alt="Nuggets empanizados back" class="miniatura-vista" id="back">
							</div>
						</div>
					</div>
					<div class="col-lg-6 col-md-6 col-sm-12 producto desktop-historia" >
						<div style="background:url('rec/img/nuestras_marcas/nuggets_back.png') no-repeat center; background-size:auto 363px;" class=" animated zoomIn">
							<img src="rec/img/nuestras_marcas/nuggets.png" alt="Nuggets empanizados" class="img-responsive img-thumbnail thumbnail-producto">
						</div>
					</div>
				</div>
			</div>
