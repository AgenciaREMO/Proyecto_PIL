			...
			<div class="container">
				...
				<div class="row productos bg-productos">
					...
					<div class="col-lg-6 col-md-6 col-sm-12 producto" >
						<div style="background:url('rec/img/nuestras_marcas/muslos_temporal_back.jpg');background-size: cover;">
							<img src="rec/img/nuestras_marcas/muslos_temporal.jpg" alt="Pollo entero" class="img-responsive img-thumbnail thumbnail-producto">
						</div>
					</div>
					<div class="col-lg-6 col-md-6 col-sm-12" >
						<table style="border:none;">
							<tr>
								<td>
									<p style="margin-top:0px;">Muslo de pollo que puedes encontrar con o sin piel en distintas porciones por empaque.</p>
									<p style="margin:5px;">Vistas:</p>
									<img src="rec/img/nuestras_marcas/muslos_temporal.jpg" alt="Pollo entero" class="miniatura-vista" id="frente">
									<img src="rec/img/nuestras_marcas/muslos_temporal_back.jpg" alt="Pollo entero back" class="miniatura-vista" id="back">
								</td>
							</tr>
							<tr>
								<td class="a-receta">
