				...
				<div class="row productos bg-productos">
					...
					<div class="col-lg-6 col-md-6 col-sm-12 producto" >
						<div style="background:url('rec/img/nuestras_marcas/muslos_temporal_back.jpg');background-size: cover;" class=" animated zoomIn">
							<img src="rec/img/nuestras_marcas/muslos_temporal.jpg" alt="Muslo" class="img-responsive img-thumbnail thumbnail-producto">
						</div>
					</div>
					<div class="col-lg-6 col-md-6 col-sm-12" >
						<table style="border:none;">
							<tr>
								<td>
									<h3 class="animated fadeInDown">Muslo de pollo que puedes encontrar con o sin piel en distintas porciones por empaque.</p>
									<br>
									<h3 class="animated fadeInDown" style="text-align:left;">Vistas:</p>
									<div class="vista animated fadeInUp">
										<img src="rec/img/nuestras_marcas/muslos_temporal.jpg" alt="Muslo" class="miniatura-vista" id="frente">
							...
							<tr>
								<td class="a-receta animated zoomIn">
									<a href="r2-muslo-tamarindo.php">
										<img src="rec/img/recetas/muslo_de_pollo_en_tamarindo.jpg" alt="Muslos de pollo al tamarindo" class="miniatura-receta img-thumbnail"><br>
										<p>Muslos de pollo al tamarindo</p>
