			...
			<div class="container">
				...
				<div class="row productos bg-productos" style="padding-top:3%; padding-bottom:3%;">
					...
					<div class="col-lg-6 col-md-6 col-sm-12" >
						...
						<p class="animated fadeInDown" style="font-size:1.3em;">Alitas de pollo con salsa tipo Buffalo, totalmente cocinadas.</p>
						<br>
						<hr class="hr-productos">
						<div class="col-lg-12 col-md-12 col-sm-12 producto movil-historia">
							<div style="background:url('rec/img/nuestras_marcas/alitas_buffalo_back.png') no-repeat center; background-size:auto 363px;" class=" animated zoomIn">
								<img src="rec/img/nuestras_marcas/alitas_buffalo_temporal.png" alt="Alitas buffalo" class="img-responsive img-thumbnail thumbnail-producto" style="max-width:100%">
							</div>
						</div>
					...
					<div class="col-lg-6 col-md-6 col-sm-12 producto desktop-historia" >
						<div style="background:url('rec/img/nuestras_marcas/alitas_buffalo_back.png') no-repeat center; background-size:auto 363px;" class=" animated zoomIn">
							<img src="rec/img/nuestras_marcas/alitas_buffalo.png" alt="Alitas buffalo" class="img-responsive img-thumbnail thumbnail-producto">
						</div>
					</div>
				</div>
			</div>
