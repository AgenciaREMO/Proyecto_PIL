			...
			<div class="container">
				...
				<div class="row productos bg-productos">
					...
					<div class="col-lg-6 col-md-6 col-sm-12 producto" >
						<img src="rec/img/nuestras_marcas/alitas_buffalo.png" alt="Alitas buffalo" class="img-responsive img-thumbnail thumbnail-producto animated zoomIn">
					</div>
					<div class="col-lg-6 col-md-6 col-sm-12" >
						<h3 class="animated fadeInDown">Alitas de pollo con salsa tipo Buffalo,<br>totalmente cocinadas.</h3>
						<br>
