<?php
	 $asunto = "Pilgrim's | Hagamos negocio";
    $num = count($_GET);
    $nombre = $_POST['nombre'];
    $email = $_POST['email'];
    ...
    if (!empty($asunto) && !empty($para)) {
        ...
        $headers .= "FROM: Pilgrim's | Hagamos negocio <pilgrims@pilgrims.com>"."\r\n".'X-Mailer: PHP/' . phpversion();
        $body = '
        <html>
          <head>
            <meta charset="utf-8">
                      ...
                      <td class="">
                        ...
                        <div style=";background-size:cover;padding:10px;">
                          ...
                          <div style="font-family:Calibri;font-style:normal;font-variant:normal;font-weight:normal;letter-spacing:normal;line-height:normal;text-indent:0px;text-transform:none;white-space:normal;word-spacing:0px;text-align:left;" class=""><font color="#666666" class="">
                            Alguien ha enviado un mensaje para <b><i>Hagamos negocio: '.$categoria.'</i></b> desde el sitio web.</font>
                          </div>
                          ...
                          <div style="font-family:Calibri;font-style:normal;font-variant:normal;font-weight:normal;letter-spacing:normal;line-height:normal;text-indent:0px;text-transform:none;white-space:normal;word-spacing:0px;text-align:left;" class=""><font color="#666666" class="">
                            <table style="width:90%;margin:auto;">
                              <tr>
                                <td style="width:20%; text-align:left;"><b>Categoría de interés: </b></td>
                                <td>'.$categoria.'</td>
                              </tr>
                              <tr>
