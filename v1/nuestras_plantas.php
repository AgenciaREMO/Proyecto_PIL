				...
				<div class="tabs-plantas">
					...
					<div class="tab-content">
						<div role="tabpanel" class="tab-pane in active" id="incubadoras">
					    	<h2 class="h3-plantas">Nuestras incubadoras</h2>
					    	<div class="row">
						    	<div class="col-lg-6">
						    		<h3><img src="rec/img/pollito.png" alt="Icono pollito" class="icon-pollito">Planta incubadora Antongo 1 y 2</h3>
						    		<p class="p-plantas">
						    		...
						    		<h3><img src="rec/img/pollito.png" alt="Icono pollito" class="icon-pollito">Planta incubadora Balvanera 1 y 2</h3>
						    		<p class="p-plantas">
						    		...
						    		<h3><img src="rec/img/pollito.png" alt="Icono pollito" class="icon-pollito">Planta incubadora La Esperanza</h3>
						    		<p class="p-plantas">
						    	...
						    	<div class="col-lg-6">
						    		<h3><img src="rec/img/pollito.png" alt="Icono pollito" class="icon-pollito">Planta incubadora Río Verde</h3>
						    		<p class="p-plantas">
						    		...
						    		<h3><img src="rec/img/pollito.png" alt="Icono pollito" class="icon-pollito">Planta Incubadora Petsa</h3>
						    		<p class="p-plantas">
						    		...
						    		<h3><img src="rec/img/pollito.png" alt="Icono pollito" class="icon-pollito">Planta Incubadora Citra</h3>
						    		<p class="p-plantas">
						    			<strong>Ubicación:</strong> Carretera Bermejillo- La Zarca km 11.5 + 2, Mapimi, Durango.<br>
										<strong>¿Qué procesa y cuánto?</strong><br>
										Incubación para producción de pollito.
						    		</p>
						    		<h3><img src="rec/img/pollito.png" alt="Icono pollito" class="icon-pollito">Planta incubadora Veracruz</h3>
						    		<p class="p-plantas">
					    ...
					    <div role="tabpanel" class="tab-pane fade" id="alimentos">
					    	<h2>Nuestras plantas de alimentos</h2>
					    	<div class="row">
						    	<div class="col-lg-6">
						    		<h3><img src="rec/img/pollito.png" alt="Icono pollito" class="icon-pollito">Planta de alimentos Querétaro</h3>
						    		<p class="p-plantas">
						    		...
						    		<h3><img src="rec/img/pollito.png" alt="Icono pollito" class="icon-pollito">Planta de alimentos Colón</h3>
						    		<p class="p-plantas">
						    		...
						    		<h3><img src="rec/img/pollito.png" alt="Icono pollito" class="icon-pollito">Planta de alimentos Saltillo</h3>
						    		<p class="p-plantas">
						    	...
						    	<div class="col-lg-6">
						    		<h3><img src="rec/img/pollito.png" alt="Icono pollito" class="icon-pollito">Planta de alimentos San Luis Potosí</h3>
						    		<p class="p-plantas">
						    		...
						    		<h3><img src="rec/img/pollito.png" alt="Icono pollito" class="icon-pollito">Planta de Alimentos 1 Durango</h3>
						    		<p class="p-plantas">
						    		...
						    		<h3><img src="rec/img/pollito.png" alt="Icono pollito" class="icon-pollito">Planta de Alimentos 2 Durango</h3>
						    		<p class="p-plantas">
						    		...
						    		<h3><img src="rec/img/pollito.png" alt="Icono pollito" class="icon-pollito">Planta de alimentos Veracruz</h3>
						    		<p class="p-plantas">
					    ...
					    <div role="tabpanel" class="tab-pane fade" id="proceso">
					      	<h2>Nuestras plantas de procesos</h2>
					      	<div class="row">
						    	<div class="col-lg-6">
						    		<h3><img src="rec/img/pollito.png" alt="Icono pollito" class="icon-pollito">Planta de proceso Tepeji de Río</h3>
						    		<p class="p-plantas">
						    		...
						    		<h3><img src="rec/img/pollito.png" alt="Icono pollito" class="icon-pollito">Planta de proceso Los Cues</h3>
						    		<p class="p-plantas">
						    		...
						    		<h3><img src="rec/img/pollito.png" alt="Icono pollito" class="icon-pollito">Planta de proceso San Luis Potosí</h3>
						    		<p class="p-plantas">
						    	...
						    	<div class="col-lg-6">
						    		<h3><img src="rec/img/pollito.png" alt="Icono pollito" class="icon-pollito">Planta Citra</h3>
						    		<p class="p-plantas">
						    		...
						    		<h3><img src="rec/img/pollito.png" alt="Icono pollito" class="icon-pollito">Planta Porvenir</h3>
						    		<p class="p-plantas">
						    		...
						    		<h3><img src="rec/img/pollito.png" alt="Icono pollito" class="icon-pollito">Planta La Popular</h3>
						    		<p class="p-plantas">
