				...
				<div class="cont-recetas">
					<div class="row encabezado">
						<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
							<div class="titulos">
								Espagueti con pollo Pilgrim’s<br> en salsa de tomate
							</div>
						</div>
					...
					<div class="hoja">
						...
						<div class="row">
							<div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
								<p>4 Mitades de <b><i>Pechuga de Pollo Pilgrim’s</i></b> sin hueso.</p><br>
							...
							<div class="col-lg-6 col-md-6 hidden-xs-down">
			...
			<section class="mob-recetario">
				<div class="cont-recetas">
					...
					<div class="hoja">
							...
							<div class="row">
								<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
									<p>4 Mitades de <b><i>Pechuga de Pollo Pilgrim’s</i></b> sin hueso.</p>
